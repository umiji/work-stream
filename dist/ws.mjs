#!/usr/bin/env node
import { createRequire as __wsCreateRequire } from 'node:module'; const require = __wsCreateRequire(import.meta.url);
...
// node_modules/.pnpm/ulid@2.4.0/node_modules/ulid/dist/index.umd.js
var require_index_umd = __commonJS({
  "node_modules/.pnpm/ulid@2.4.0/node_modules/ulid/dist/index.umd.js"(exports, module) {
...
var CaptureKindSchema = external_exports.enum(["thought", "reference", "log"]);
var OriginSchema = external_exports.enum(["self", "external"]);
var SourceRefSchema = external_exports.object({
  docUrl: external_exports.string().url().optional(),
  conversationUrl: external_exports.string().url().optional(),
  project: external_exports.string().optional()
}).strict();
var CapturedItemSchema = external_exports.object({
  ...
  originalTimestamp: external_exports.string().datetime({ offset: true }).optional(),
...
var EventEnvelopeSchema = external_exports.object({
  ...
  dedupeKey: external_exports.string().min(1),
  correlationId: external_exports.string().min(1),
  payload: external_exports.record(external_exports.unknown())
});
var ItemCapturedEventSchema = EventEnvelopeSchema.extend({
...
function buildCapturedItem(input) {
...
var RepoMarkerSchema = external_exports.object({
  defaultDomain: external_exports.string().min(1).optional()
});
...
function serializeCapturedItem(item) {
  const { content, ...frontmatter } = item;
  const yamlBlock = (0, import_yaml.stringify)(frontmatter).trimEnd();
  return `---
${yamlBlock}
---
...
program2.name("ws").description("work-stream CLI(P0-a: capture \u306E\u307F\u5B9F\u88C5)");
program2.command("capture").description("\u6C17\u3065\u304D\u30FB\u691C\u8A0E\u30FB\u8A18\u9332\u3092 knowledge-repo \u306E inbox/ \u3078\u53D6\u308A\u8FBC\u3080").requiredOption("--kind <kind>", "thought | reference | log").option("--file <path>", "\u5185\u5BB9\u3092\u30D5\u30A1\u30A4\u30EB\u304B\u3089\u8AAD\u3080(\u7701\u7565\u6642\u306F\u6A19\u6E96\u5165\u529B)").option("--origin <origin>", "self | external (\u7701\u7565\u6642\u306F self)", "self").action((opts) => {
  try {
    ...
    const rawContent = opts.file ? readFileSync2(opts.file, "utf-8") : readFileSync2(0, "utf-8");
